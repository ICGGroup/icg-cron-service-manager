...
(function() {
  var async, cluster, domain, jobs, logWrapper, moment, oi, path, util, _;
      ...
      return jobDomain.run(function() {
        ...
        cronJob = new CronJob(options.cron, function() {
          ...
          cb = function(err) {
            var _ref5, _ref6;
            if (err) {
              return (_ref5 = config.log) != null ? _ref5.error(err, job) : void 0;
            } else {
              return (_ref6 = config.log) != null ? _ref6.info("Job completed", job.job) : void 0;
            }
          };
          if ((_ref5 = config.log) != null) {
            _ref5.info("Job starting", job.job);
          }
